...
#Dependancy injection for get_repositories
def get_service()->ProfileService:
    return ProfileService()# There should be parenthesis, or then it will only return the class itself rather than instance of that class
